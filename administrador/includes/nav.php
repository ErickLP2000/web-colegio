...
<div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="lista_alumnos.php"><i class="app-menu__icon bi bi-person-rolodex"></i><span class="app-menu__label">Alumnos</span></a></li>
        ...
        <li><a class="app-menu__item" href="lista_profesor_grados.php"><i class="app-menu__icon bi bi-bookmark"></i><span class="app-menu__label">Profesor Grado</span></a></li>
