...
<div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="admin_reportes.php"><i class="app-menu__icon fa-solid fa-circle-exclamation"></i><span class="app-menu__label">Reportes</span></a></li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa-solid fa-book"></i><span class="app-menu__label">Secciones</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
          ...
          <li><a class="treeview-item" href="lista_grados.php"><i class="app-menu__icon fa-solid fa-circle"></i><span class="app-menu__label">Grados</span></a></li>
          <li><a class="treeview-item" href="lista_aulas.php"><i class="app-menu__icon fa-solid fa-circle"></i><span class="app-menu__label">Aulas</span></a></li>
          <li><a class="treeview-item" href="lista_materias.php"><i class="app-menu__icon fa-solid fa-circle"></i><span class="app-menu__label">Materias</span></a></li>
          <li><a class="treeview-item" href="lista_periodos.php"><i class="app-menu__icon fa-solid fa-circle"></i></i><span class="app-menu__label">Periodos</span></a></li>
          <li><a class="treeview-item" href="lista_actividades.php"><i class="app-menu__icon fa-solid fa-circle"></i></i><span class="app-menu__label">Actividades</span></a></li>
          </ul>
        </li>
