<?php
    ...
    $sql = 'SELECT * FROM profesor_grado as pg INNER JOIN profesor as p ON pg.profesor_id = p.profesor_id INNER JOIN grados as g ON pg.grado_id = g.grado_id INNER JOIN aulas as a ON pg.aula_id = a.aula_id INNER JOIN periodos as pe ON pg.periodo_id = pe.periodo_id WHERE pg.estadopg !=0';
